...
{
    public class KonradGalazkaTransferHandlerFactory : DelegateFactoryBase<TransferHandler>
    {
        public KonradGalazkaTransferHandlerFactory()
        {
            ListOfInstances = new Dictionary<string, Func<TransferHandler>>()
            {
                ...
                {"2190", () => new DnBNordTransferHandler()},
            };
        }
    }
}